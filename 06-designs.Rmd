...
```{r, echo=FALSE, out.width="50%", fig.cap="EBM pyramid of research designs", fig.align="center"}
...
```{r, echo=FALSE, out.width="1000%", fig.cap="Overview of different research designs", fig.align="center"}
...
```{r, echo=FALSE, out.width="50%", fig.cap=c("Case control sampling times"), fig.align="center"}
...
```{r, echo=FALSE, out.width="1000%", fig.cap=c("Effect measures from case control designs"), fig.align="center"}
