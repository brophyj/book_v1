...
```{r pyramid, echo=FALSE, out.width="50%", fig.cap="EBM pyramid of research designs", fig.align="center"}
knitr::include_graphics("img/ebm/pyramid.png")
```
...
```{r better, echo=FALSE, out.width="50%", fig.cap="Better EBM pyramid of research designs", fig.align="center"}
knitr::include_graphics("img/ebm/pyramid_good.png")
```
...
```{r overview, echo=FALSE, out.width="1000%", fig.cap="Overview of different research designs", fig.align="center"}
knitr::include_graphics("img/ebm/overview.png")
```
...
```{r ecology, echo=FALSE, out.width="1000%", fig.cap="Ecological bias", fig.align="center"}
knitr::include_graphics("img/ebm/ecological.png")
```
...
```{r jama, echo=FALSE, out.width="100%", fig.cap="JAMA Internal Medicine Top 2019 Altmetric Articles", fig.align="center"}
knitr::include_graphics("img/ebm/jama.png")
```
...
```{r, echo=FALSE, out.width="50%", fig.cap=c("Observational research design", "Experimental research design"), fig.align="center"}
knitr::include_graphics("img/ebm/cohort.png")
knitr::include_graphics("img/ebm/rct.png")
```
...
```{r cc, echo=FALSE, out.width="50%", fig.cap=c("Case control sampling times"), fig.align="center"}
knitr::include_graphics("img/ebm/cc.png")
```
...
The OR is `r full$res$OR.strata.wald$est` with 95% CI `r full$res$OR.strata.wald$lower` - `r full$res$OR.strata.wald$upper`. The OR is fairly close to incident risk ratio for the full cohort (RR = `r full$res$RR.crude.score$est`) since the rare assumption is approximately true, about 10% incidence.\
If we select only 1/10 of the controls the OR is `r full.10$res$OR.strata.wald$est` with 95% CI `r full.10$res$OR.strata.wald$lower` - `r full.10$res$OR.strata.wald$upper`, a trivial difference.\
On the other hand, suppose we take a 1/10 sample of the cases, the OR remains unbiased at `r full.case10$res$OR.strata.wald$est` but the 95% CI `r full.case10$res$OR.strata.wald$lower` - `r full.case10$res$OR.strata.wald$upper` is much larger. It is this lack of precision that mandates the inclusion of all cases in a case / control design.\
...
```{r measures, echo=FALSE, out.width="1000%", fig.cap=c("Effect measures from case control designs"), fig.align="center"}
knitr::include_graphics("img/ebm/cc_measures.png")
```
