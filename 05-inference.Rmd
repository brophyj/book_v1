...
```{r echo=FALSE, out.width="50%", fig.align = "center", fig.cap=c("Addition rule", "Multiplication rule", "Total probability rule")}
knitr::include_graphics("img/5_stats/addition1.png")
knitr::include_graphics("img/5_stats/cond_venn1.png")
knitr::include_graphics("img/5_stats/total_p1.png")
```
...
```{r echo=FALSE, out.width="100%", fig.align = "center", fig.cap=c("Analogy between diagnostic testing and research findings")}
knitr::include_graphics("img/5_stats/dx_res.png")
```
...
```{r design, echo=FALSE, out.width="100%", fig.align = "center", fig.cap=c("Positive predictive values for various research designs and parameter")}
knitr::include_graphics("img/5_stats/design_R.png")
```
...
```{r echo=FALSE, out.width="75%", fig.align = "center", fig.cap=c("Adequately powered exploratory epidemiology study no bias", "Adequately powered xploratory epidemiology study with 30% bias")}
knitr::include_graphics("img/5_stats/ex1.png")
```
...
```{r echo=FALSE, out.width="75%", fig.align = "center", fig.cap=c("Adequately powered exploratory epidemiology study no bias", "Adequately powered xploratory epidemiology study with 30% bias")}
knitr::include_graphics("img/5_stats/ex2.png")
```
...
```{r echo=FALSE, out.width="75%", fig.align = "center", fig.cap=c("General Assocation of Research Findings and True Relationships in the Presence of Bias")}
knitr::include_graphics("img/5_stats/general.png")
```
...
```{r bayes, echo=FALSE, out.width="100%", fig.align = "center", fig.cap=c("Bayes theorem")}
knitr::include_graphics("img/5_stats/bayes.png")
```
...
```{r conv, echo=FALSE, out.width="100%", fig.align = "center", fig.cap=c("P values, BF and probabilities")}
knitr::include_graphics("img/5_stats/conv.png")
```
